...
// monsterName - входящий параметр. Их количество не ограничено, но обязательно стоит указывать тип параметра (String, Int, Bool и т.д.)



/**
 canIGetThisItem - название функции
 - parameter dropList: Входящий параметр
...
// Если по какой-то причине вы решили, что в вашей функции необходимы не обязательные параметры,
