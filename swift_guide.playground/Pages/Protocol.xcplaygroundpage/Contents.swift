...
//: > Особенностью Xcode является то, что если имплементировать объекту *Протокол* - вы автоматически получите предложение применить к объекту всю функциональность указанного *Протокола*.
