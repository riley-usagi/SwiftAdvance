...
struct Monk {
  ...
  var timeBetweenAttacks: Float = 2.01
  
  /// Урон в минуту
  var damagePerMinute: Float {
    get {
      // Стандартная формула расчёта урона в минуту
      return 50 / timeBetweenAttakcs
    }
  }
  
  /// Выпил ли герой напиток на увеличение скорости атаки
  var awakening: Bool
//  {
//    get {
...
//    set {
//      if self.awakening {
//        self.timeBetweenAttaks * 0.1
//      }
//    }
//  }
}

//let monk = Monk(timeBetweenAttaks: 2.1, awakening: true)
let monk = Monk(timeBetweenAttacks: 1, awakening: true)
// Значение урона в минуту автоматически вычислилось благодаря заранее заданной формуле.
monk.damagePerMinute
